...
# Send forces to Falcons
		...
		LzsHh_list.append(np.array(LzsHh).flatten())
		LzdHh_list.append(np.array(LzdHh).flatten())
		LzrR_list.append(np.array(LzrR).flatten())
		LzlR_list.append(np.array(LzlR).flatten())
		...
		data_dict = {
		    ...
		    'LzsHh': np.array(LzsHh_list),
		    'LzdHh': np.array(LzdHh_list),
		    'LzrR': np.array(LzrR_list),
		    'LzlR': np.array(LzlR_list)
		}
