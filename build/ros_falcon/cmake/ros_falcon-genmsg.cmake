...
set(MSG_I_FLAGS "-Iros_falcon:/home/user/_wsAryan/haptic_ws/src/ros_falcon/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/user/_wsAryan/haptic_ws/src/ros_falcon/msg/falconForces.msg" NAME_WE)
add_custom_target(_ros_falcon_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_falcon" "/home/user/_wsAryan/haptic_ws/src/ros_falcon/msg/falconForces.msg" ""
)

get_filename_component(_filename "/home/user/_wsAryan/haptic_ws/src/ros_falcon/msg/falconSetPoint.msg" NAME_WE)
add_custom_target(_ros_falcon_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_falcon" "/home/user/_wsAryan/haptic_ws/src/ros_falcon/msg/falconSetPoint.msg" ""
)

get_filename_component(_filename "/home/user/_wsAryan/haptic_ws/src/ros_falcon/msg/falconPos.msg" NAME_WE)
add_custom_target(_ros_falcon_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_falcon" "/home/user/_wsAryan/haptic_ws/src/ros_falcon/msg/falconPos.msg" ""
)
...
### Generating Messages
_generate_msg_nodejs(ros_falcon
  "/home/user/_wsAryan/haptic_ws/src/ros_falcon/msg/falconForces.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ros_falcon
)
_generate_msg_nodejs(ros_falcon
  "/home/user/_wsAryan/haptic_ws/src/ros_falcon/msg/falconSetPoint.msg"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_nodejs(ros_falcon
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ros_falcon
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(ros_falcon_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(ros_falcon_generate_messages ros_falcon_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/user/_wsAryan/haptic_ws/src/ros_falcon/msg/falconForces.msg" NAME_WE)
add_dependencies(ros_falcon_generate_messages_nodejs _ros_falcon_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/user/_wsAryan/haptic_ws/src/ros_falcon/msg/falconSetPoint.msg" NAME_WE)
add_dependencies(ros_falcon_generate_messages_nodejs _ros_falcon_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/user/_wsAryan/haptic_ws/src/ros_falcon/msg/falconPos.msg" NAME_WE)
add_dependencies(ros_falcon_generate_messages_nodejs _ros_falcon_generate_messages_check_deps_${_filename})
...
# target for backward compatibility
add_custom_target(ros_falcon_gennodejs)
add_dependencies(ros_falcon_gennodejs ros_falcon_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS ros_falcon_generate_messages_nodejs)
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ros_falcon)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ros_falcon
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(ros_falcon_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_falcon)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_falcon\")")
  # install generated code
  install(
