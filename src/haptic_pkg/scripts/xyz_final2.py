...
# Solve Riccati equation safely
		...
		LzlR = LzR - LzrR
                ...
                if (test == 1):  # lowering phase (you already feel resistance here)
    			left_falcon(-uxlH + uxrH + uxlR, -uylH + uyrH + uylR, -uzlH - uzrH )
    			right_falcon(-uxrH + uxlH + uxrR, -uyrH + uylH + uyrR, -uzrH - uzlH )
			
		else:  # lifting phase (add resistance by subtracting adaptive term)
