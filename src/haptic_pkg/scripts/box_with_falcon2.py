...
def box_pos_cb(data):
    ...
    try:
        ...
        rospy.logwarn_throttle(5, "Model 'virtual_box::link' not found in /gazebo/link_states.")
    ...
    try:
        ...
        while not rospy.is_shutdown():
            if(time.time() - prev_time >= 0.01):
                ...
                force_left_box_x = sensi_xy * apply_deadzone(pos_falcon_left[0])
		force_left_box_y = sensi_xy * apply_deadzone(pos_falcon_left[1])
		force_left_box_z = sensi_z * apply_deadzone(pos_falcon_left[2])

		force_right_box_x = sensi_xy * apply_deadzone(pos_falcon_right[0])
		force_right_box_y = sensi_xy * apply_deadzone(pos_falcon_right[1])
		force_right_box_z = sensi_z * apply_deadzone(pos_falcon_right[2])
                ...
                pub_box_force_left(force_left_box_x,force_left_box_y,force_left_box_z) 
                pub_box_force_right(force_right_box_x,force_right_box_y,force_right_box_z)
