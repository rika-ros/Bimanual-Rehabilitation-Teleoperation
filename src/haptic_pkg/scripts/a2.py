...
QxR=np.diag([0.1,0])       #Robot parameters
#Qxsum=np.diag([0.1,0])
LxHh=np.matrix([[0,0]])
    ...
    try:
        ...
        while not rospy.is_shutdown():
            if(time.time() - prev_time >= dt):
                ...
                exr=pos_box[0]-pos_falcon_right[0]*100
                ...
                #box(flb[0]+frb[0],flb[1]+frb[1],flb[2]+frb[2])
                left_falcon(-flH[0]+flR[0]+frb[0],-flH[1]+flR[1]+frb[1],-flH[2]+flR[2]+frb[2])#(-0,0,0)#(-flH[0]+flR[0]+frb[0],-flH[1]+flR[1]+frb[1],-flH[2]+flR[2]+frb[2])
                right_falcon(-frH[0]+frR[0]+flb[0],-frH[1]+frR[1]+flb[1],-frH[2]+frR[2]+flb[2])#(0,0,0)#(-frH[0]+frR[0]+flb[0],-frH[1]+frR[1]+flb[1],-frH[2]+frR[2]+flb[2])
                X = np.matrix([[pos_box[0]],[vel_box[0]]])
                Y = np.matrix([[pos_box[1]],[vel_box[1]]])
                Z = np.matrix([[pos_box[2]],[vel_box[2]]])
                xix=X-Xd
